...
public class Rook extends Piece{
    ...
    public void possibleQueenMoves(List<Move> list,int xHolder,int yHolder,int x, int y,int xIncrement, int yIncrement,Piece [][]gameBoard,List<String> notation,boolean validMoveChecker){
        ...
        while(xHolder!=gameBoard.length && xHolder!=-1 && yHolder!=gameBoard.length && yHolder!=-1 && gameBoard[xHolder][yHolder]==null){
            ...
            possibleRookTake(list,xHolder,yHolder,x,y,gameBoard,notation,validMoveChecker);
    ...
    public void possibleRookTake(List<Move> list,int xHolder,int yHolder,int x, int y,Piece [][]gameBoard,List<String> notation,boolean validMoveChecker){
